...
\par
На почетку, у оквиру линија 36-38, се низ, у којем се бележе растојања, иницијализује за сваки чвор $v_i$ на бесконачност (највећа целобројна вредност), док је растојање до почетног чвора постављена на вредност $0$. Након овога се, у оквиру линија 40 и 41 врши алоцирање меморије за низове \cinline{fs} и \cinline{ns} (\cinline{fs} - frontier set; \cinline{ns} - next frontier set). У низ \cinline{fs} се убацује индекс почетног чвора \cinline{start} (линија 43), а затим се у линијама 45, 46 и 47 врши иницијализација променљивих \cinline{level}, \cinline{count1} и \cinline{count2} респективно. Променљива \cinline{level} бележи тренутни ниво, односно дубину графа која се обрађује у итерацији, \cinline{count1} бележи дужину низа \cinline{fs}, док \cinline{count2} бележи дужину низа \cinline{ns}.

\par
У линијама 49 до 65 се налази петља која итерира све док низ \cinline{fs} није празан, односно промељива \cinline{count1} има вредност већу од нуле. У линијама 51 до 60 се налази петља којом се итерирају елементи низа \cinline{fs}. Сваки елемент бива смештен у променљиву \cinline{node} која се у линијама 53-59 користи за рачунање помераја у оквиру низа \cinline{degrees} и поново у петљи итерира сегмент у низу \cinline{graph}, одакле се добијају суседи чвора \cinline{node} односно променљива \cinline{neighbour} за сваку итерацију, која када се употреби као индекс у окивур низа \cinline{distance} и очита вредност која је \cinline{INFINITY}, следи упис вредности \cinline{level + 1} на њено место као и убацивање самог индекса у низ \cinline{ns} који ће се итерирати у следећем нивоу.

\par
Као последње инструкције у \cinline{while} петљи у оквиру линија 61-64 врши се замена низова \cinline{fs} и \cinline{ns}, ажурирање променљивих које бележе њихову величину, као и инкрементирање вредности променљиве \cinline{level}. У линијама 67 и 68 се врши деалоцирање низова \cinline{ns} и \cinline{fs} респективно.
