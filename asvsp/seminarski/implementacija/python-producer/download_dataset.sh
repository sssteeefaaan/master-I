...
DEFAULT_FILEID="1A_ucohvveWIWkeGMQmlfGpPuQDM0dMwk"
DEFAULT_FILENAME="archive.tar.gz"
DEFAULT_CSV_OUTPUT_FILENAME="network-traffic.csv"
...
cp $(pwd)/$decomp_dir/*.csv "./$csvoutputfilename"
